...
@FunctionTemplate(name = "st_geosize", scope = FunctionTemplate.FunctionScope.SIMPLE,
        nulls = FunctionTemplate.NullHandling.NULL_IF_NULL)
public class STGeoSize implements SimpleFunction {
    @Param
    ...
    public void eval() {
        ...
        out.value = geom1Param.end - geom1Param.start;
    }
}