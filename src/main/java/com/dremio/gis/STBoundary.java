...
@FunctionTemplate(name = "st_boundary", scope = FunctionTemplate.FunctionScope.SIMPLE,
        nulls = FunctionTemplate.NullHandling.NULL_IF_NULL)
public class STBoundary implements SimpleFunction {
    @Param
    ...
    public void eval() {
        ...
        com.esri.core.geometry.ogc.OGCGeometry boundaryGeom = geom1.boundary();

        java.nio.ByteBuffer bufferedGeomBytes = boundaryGeom.asBinary();
