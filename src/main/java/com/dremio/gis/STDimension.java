...
@FunctionTemplate(name = "st_dimension", scope = FunctionTemplate.FunctionScope.SIMPLE,
        nulls = FunctionTemplate.NullHandling.NULL_IF_NULL)
public class STDimension implements SimpleFunction {
    @Param
