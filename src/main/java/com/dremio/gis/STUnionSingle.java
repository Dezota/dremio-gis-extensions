...
public class STUnionSingle implements SimpleFunction {
    @Param
    ...
    public void eval() {
        ...
        com.esri.core.geometry.GeometryCursor inputGeomCur = geom1.getEsriGeometryCursor();
        ...
        com.esri.core.geometry.ogc.OGCGeometry unionGeom = com.esri.core.geometry.ogc.OGCGeometry.createFromEsriCursor(unionGeomCur, geomSR);
