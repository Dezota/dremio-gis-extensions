...
@FunctionTemplate(name = "h3_kringdistances", scope = FunctionTemplate.FunctionScope.SIMPLE,
        nulls = FunctionTemplate.NullHandling.NULL_IF_NULL, derivation = com.dremio.gis.H3KRingDistancesOutputDerivation.class)
